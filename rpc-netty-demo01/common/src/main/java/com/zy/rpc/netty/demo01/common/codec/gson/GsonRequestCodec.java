...
public class GsonRequestCodec implements Codec {
    @Override
    public byte getCode() {
        return Serialization.Type.GSON.getRequestCode();
    }

    @Override
    public Class<?> getRpcMsgClass() {
        return GsonRequest.class;
    }

    @Override
    public Request getRequest(Object msg) {
        GsonRequest request = (GsonRequest) msg;
